...
app.Animation = (function () {
    ...
    function start() {
        ...
        pintl1.from(pin1, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=5.1")
        ...
        pintl2.from(pin2, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=5.2")
        ...
        pintl3.from(pin3, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=5.3")
        ...
        pintl4.from(pin4, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=5.4")
        ...
        pintl5.from(pin5, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=5.5")
        ...
        tltxt.to(txt1, .25, {opacity: 1}, "+=.75")
            .fromTo(txt1, .5, {y: "-=20"}, {y: "+=23", ease: Sine.easeOut}, "-=.25")
            .to(txt1, .2, {y: "-=3", ease: Sine.easeInOut})

            .to(txt2, .25, {opacity: 1}, "+=1.5")
            .fromTo(txt2, .5, {y: "-=20"}, {y: "+=23", ease: Sine.easeOut}, "-=.25")
            .to(txt2, .2, {y: "-=3", ease: Sine.easeInOut})

            .to(txt3, .25, {opacity: 1}, "+=2")

            .to(cta, .25, {opacity: 1}, "+=1.5")
            .fromTo(cta, .5, {y: "-=20"}, {y: "+=23", ease: Sine.easeOut}, "-=.25")
