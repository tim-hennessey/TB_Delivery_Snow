...
app.Animation = (function () {
    ...
    function start() {
        ...
        pintl1.from(pin1, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=4.1")
        ...
        pintl2.from(pin2, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=4.2")
        ...
        pintl3.from(pin3, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=4.3")
        ...
        pintl4.from(pin4, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=4.4")
        ...
        pintl5.from(pin5, .25, {scale:"-=.2", opacity:0, ease: Sine.easeInOut}, "+=4.5")
